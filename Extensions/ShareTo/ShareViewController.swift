...
let ShareDestinationOpenLater: String = "Open later"
let ShareDestinationBookmarks: String = "Bookmarks"
let ShareDestinationReadingList: String = "ReadingList"

let ShareDestinations = [
    ShareDestination(code: ShareDestinationOpenLater, name: NSLocalizedString("Open later", tableName: "ShareTo", comment: "Button to open the URL in a tab in Firefox in the background"), image: "AddToReadingList"),   // TODO
